...
:setvar equivTable "CELLMARK_EQUIV"

-- Copy source table
EXEC create_equiv_table $(equivTable), 'CELLMARK'
GO
...
UPDATE $(equivTable) set EQUIV_CLS=CONCAT(COMPONENT,'|',PROPERTY_REV,'|',SYSTEM_REV);
...
select heading as 'Heading', EQUIV_CLS, LOINC_NUM, COMPONENT, PROPERTY, PROPERTY_REV,
 ...
 SYSTEM, SYSTEM_REV, LONG_COMMON_NAME,
