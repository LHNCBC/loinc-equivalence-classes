...
:setvar equivTable "MOLPATH_EQUIV"

-- Copy source table
EXEC create_equiv_table $(equivTable), 'MOLPATH'
GO

-- Component column --
--EXEC dup_column $(equivTable), 'COMPONENT', 'COMPONENT_REV'
--GO
--EXEC apply_groups $(equivTable), 'COMPONENT_REV', 'MOLPATH_COMPONENT', 'Component_Rev';

--- System column --
EXEC dup_column $(equivTable), 'SYSTEM', 'SYSTEM_REV'
GO
EXEC apply_groups $(equivTable), 'SYSTEM_REV', 'MOLPATH_SYSTEM', 'System_Rev';

-- Property column --
--EXEC dup_column $(equivTable), 'PROPERTY', 'PROPERTY_REV'
--GO
--EXEC apply_groups $(equivTable), 'PROPERTY_REV', 'MOLPATH_PROPERTY', 'Property_Rev';

-- METHOD column--
--EXEC dup_column $(equivTable), 'METHOD_TYP', 'METHOD_REV'
--GO
--EXEC apply_groups $(equivTable), 'METHOD_REV', 'MOLPATH_METHOD', 'Method_Rev';

-- Scale column --
--EXEC dup_column $(equivTable), 'SCALE_TYP', 'SCALE_REV'
--GO
--EXEC apply_groups $(equivTable), 'SCALE_REV', 'MOLPATH_SCALE', 'Scale_Rev';
...
UPDATE $(equivTable) set EQUIV_CLS=CONCAT(COMPONENT,'|',SYSTEM_REV);
