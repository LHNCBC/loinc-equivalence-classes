...
:setvar equivTable "CYTO_EQUIV"

-- Copy source table
EXEC create_equiv_table $(equivTable), 'CYTO'
GO

-- Component column --
EXEC dup_column $(equivTable), 'COMPONENT', 'COMPONENT_REV'
GO
EXEC apply_groups $(equivTable), 'COMPONENT_REV', 'CYTO_COMPONENT', 'Component_Rev';

--- System column --
EXEC dup_column $(equivTable), 'SYSTEM', 'SYSTEM_REV'
GO
EXEC apply_groups $(equivTable), 'SYSTEM_REV', 'CYTO_SYSTEM', 'System_Rev';

-- Property column --
--EXEC dup_column $(equivTable), 'PROPERTY', 'PROPERTY_REV'
--GO
--EXEC apply_groups $(equivTable), 'PROPERTY_REV', 'CYTO_PROPERTY', 'Property_Rev';

-- METHOD column--
--EXEC dup_column $(equivTable), 'METHOD_TYP', 'METHOD_REV'
--GO
--EXEC apply_groups $(equivTable), 'METHOD_REV', 'CYTO_METHOD', 'Method_Rev';

-- Scale column --
EXEC dup_column $(equivTable), 'SCALE_TYP', 'SCALE_REV'
GO
EXEC apply_groups $(equivTable), 'SCALE_REV', 'CYTO_SCALE', 'Scale_Rev';
...
UPDATE $(equivTable) set EQUIV_CLS=CONCAT(COMPONENT_REV,'|',SYSTEM_REV,'|',SCALE_REV);
...
:setvar countField COMPONENT_REV
...
select heading as 'Heading', EQUIV_CLS, LOINC_NUM, COMPONENT, COMPONENT_REV,-- PROPERTY, PROPERTY_REV,
