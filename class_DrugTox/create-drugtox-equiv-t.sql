...
:setvar equivTable "DRUGTOX_EQUIV"
...
select heading as 'Heading', EQUIV_CLS, LOINC_NUM, COMPONENT, EXAMPLE_UCUM_UNITS, PROPERTY, PROPERTY_REV,
 SYSTEM, SYSTEM_REV, METHOD_TYP, METHOD_REV, SCALE_TYP, SCALE_REV, LONG_COMMON_NAME,
 MOLECULAR_WEIGHT, SORT_ORDER from #EQUIV_TEMP order by SORT_ORDER, heading desc
