...
:setvar equivTable "ABXBACT_EQUIV"

-- Copy source table
EXEC create_equiv_table $(equivTable), 'ABXBACT'
GO

-- System column --
--EXEC dup_column $(equivTable), 'SYSTEM', 'SYSTEM_REV'
--GO
--EXEC apply_groups $(equivTable), 'SYSTEM_REV', 'ABXBACT_SYSTEM', 'System_Rev';

-- Property column --
EXEC dup_column $(equivTable), 'PROPERTY', 'PROPERTY_REV'
GO
EXEC apply_groups $(equivTable), 'PROPERTY_REV', 'ABXBACT_PROPERTY', 'Property_Rev';

-- METHOD column--
EXEC dup_column $(equivTable), 'METHOD_TYP', 'METHOD_REV'
GO
EXEC apply_groups $(equivTable), 'METHOD_REV', 'ABXBACT_METHOD', 'Method_Rev';
...
UPDATE $(equivTable) set EQUIV_CLS=CONCAT(COMPONENT,'|',PROPERTY_REV,'|',METHOD_REV);
...
select heading as 'Heading', EQUIV_CLS, LOINC_NUM, COMPONENT, PROPERTY, PROPERTY_REV,
 ...
 METHOD_TYP, METHOD_REV, LONG_COMMON_NAME,
