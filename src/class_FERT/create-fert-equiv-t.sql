...
:setvar equivTable "FERT_EQUIV"

-- Copy source table
EXEC create_equiv_table $(equivTable), 'FERT'
GO

-- Component column --
--EXEC dup_column $(equivTable), 'COMPONENT', 'COMPONENT_REV'
--GO
--EXEC apply_groups $(equivTable), 'COMPONENT_REV', 'FERT_COMPONENT', 'Component_Rev';

--- System column --
--EXEC dup_column $(equivTable), 'SYSTEM', 'SYSTEM_REV'
--GO
--EXEC apply_groups $(equivTable), 'SYSTEM_REV', 'FERT_SYSTEM', 'System_Rev';

-- Property column --
EXEC dup_column $(equivTable), 'PROPERTY', 'PROPERTY_REV'
GO
EXEC apply_groups $(equivTable), 'PROPERTY_REV', 'FERT_PROPERTY', 'Property_Rev';

-- METHOD column--
--EXEC dup_column $(equivTable), 'METHOD_TYP', 'METHOD_REV'
--GO
--EXEC apply_groups $(equivTable), 'METHOD_REV', 'FERT_METHOD', 'Method_Rev';

-- Scale column --
EXEC dup_column $(equivTable), 'SCALE_TYP', 'SCALE_REV'
GO
EXEC apply_groups $(equivTable), 'SCALE_REV', 'FERT_SCALE', 'Scale_Rev';
...
UPDATE $(equivTable) set EQUIV_CLS=CONCAT(COMPONENT,'|',PROPERTY_REV,'|',SCALE_REV);
...
:setvar countField PROPERTY_REV
...
select heading as 'Heading', EQUIV_CLS, LOINC_NUM, COMPONENT, --COMPONENT_REV,
 PROPERTY, PROPERTY_REV,
